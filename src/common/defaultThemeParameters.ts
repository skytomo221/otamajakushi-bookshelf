...
const defaultThemeParameters: Required<StyleThemeParameters> = {
  ...
  EditableDiv: 'relative hover:bg-slate-400/20',
  EditableSpan: 'relative hover:bg-slate-400/20',
  EditButton: 'text-sm text-blue-500',
  Error: 'bg-rose-100 border-2 border-rose-500 text-rose-500',
  FormDiv: '',
  FormSpan: '',
  'Hero': 'p-10',
  'Hero.h2': 'text-6xl',
  'Hero.h3': 'text-4xl',
  'Hero.h4': 'mt-4 text-xl',
  'Hero.BookControllerDiv': 'm-4',
  'Hero.ButtonGroup': 'flex',
  'Hero.button': 'flex-1 m-0.5 p-3 space-y-2 hover:bg-slate-400/20',
  'Index.button': 'flex-1 text-left',
  'Index.li': 'flex m-1',
  InputText: '',
  InputSubmit: 'text-sm text-blue-500',
  InputReset: 'text-sm text-rose-500',
